...
echo "🧪 Email Template Integration Test"
echo "================================="
...
# Try to run a simple template test
echo "🎨 Testing template rendering..."

# Create a minimal test class with minimal dependencies
cat > src/main/kotlin/com/athletetracker/demo/MinimalTemplateTest.kt << 'EOF'
...
java -cp "build/classes/kotlin/main:$(find ~/.gradle -name "*.jar" | grep -E "(mustache|spring-core|kotlin)" | head -10 | tr '\n' ':')" com.athletetracker.demo.MinimalTemplateTest